...
function BottomBarContent(props) {
  ...
  const sendOneMessage = async () => {
    ...
    var newMessage = {};
    if(filePreview){
      newMessage = { sender: 'user', text: input, file : file.name };
    }else{
      newMessage = { sender: 'user', text: input, file : null };
    }
  ...
  const showEmotionalSymbol = (event) => {
    setAnchorEl(event.currentTarget);
  };

  const hideEmotionalSymbol = () => {
    setAnchorEl(null);
  };
        ...
        <Box display="flex" alignItems="center">
          ...
          >
            <IconButton
              ...
              color="primary"
              onClick={showEmotionalSymbol}
            >
              {/* 😀 */}
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_28_1551)">
          ...
          <Tooltip arrow placement="top" title="Attach a file">
            <IconButton sx={{ mx: 1, color: 'text.third' }} component="span" onClick={showFileUpload} >
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.8033 10.4665L9.94233 18.0854C8.75873 19.2326 8.75873 21.0935 9.94233 22.2407V22.2407C11.1259 23.3878 13.046 23.3878 14.2296 22.2407L24.5925 12.1969C26.7634 10.0929 26.7634 6.68204 24.5925 4.57802V4.57802C22.4216 2.47399 18.9024 2.47399 16.7315 4.57802L6.36862 14.6218C3.21046 17.6827 3.21046 22.6434 6.36862 25.7043V25.7043C9.52678 28.7652 14.6452 28.7652 17.8033 25.7043L24.0924 19.6089" stroke="#667085" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </IconButton>
          ...
          <Button
            ...
            sx={{ color: 'text.third', pr: 0 }}
          />
        </Box>
        <Menu
          anchorEl={anchorEl}
          open={Boolean(anchorEl)}
          onClose={hideEmotionalSymbol}
          // hideBackdrop
          PaperProps={{
